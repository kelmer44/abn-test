...
class GetVenuesUseCase(private val venueRepository: VenueRepository, schedulerProvider: SchedulerProvider, networkInteractor: NetworkInteractor) :
    ResourceSingleUseCase<List<Venue>, GetVenuesUseCase.Params>(schedulerProvider, networkInteractor) {
